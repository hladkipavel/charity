...
<body>
<form class="form-delete" action="/admin/admin-delete" method="post">
    <input type="hidden" name="id" value="${admin.id}">
    <div class="form-container-delete">
        <div class="form-delete">
            <h3 class="h3-delete">Czy napewno chesz to usunąć <strong>${admin.firstName} ${admin.lastName}</strong> ?</h3>
