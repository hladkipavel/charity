         ...
         <div class="container-div">
            ...
            <c:forEach items="${institutions}" var="institution" varStatus="status">
                 <tr>
                     ...
                     <td>
                         <a class="btn-option" href='<c:url value="/admin/delete?id=${institution.id}"/>'>Szczegóły</a>
                         <a class="btn-option" href='<c:url value="/admin/delete?id=${institution.id}"/>'>Edit</a>
                         <a class="btn-option" href='<c:url value="/admin/delete?id=${institution.id}"/>'>Usuń</a>
                     </td>
                 </tr>
            </c:forEach>
                 </tbody>
