...
<form:form cssClass="form-admin" method="post" action="/admin/add-admin" modelAttribute="admin">
    ...
    <form:label cssClass="label-admin" path="lastName" for="lastName">Nazwisko administratora:</form:label>
    <form:input cssClass="input-admin" path="lastName" type="text" name="lastName" id="lastName"/>
    <form:label cssClass="label-admin" path="email" for="email">Email administratora:</form:label>
    <form:input cssClass="input-admin" path="email" type="text" name="email" id="email"/>
    <form:label cssClass="label-admin" path="password" for="password">Hasło administratora:</form:label>
